...
import { colors, spacing, typography, type ThemedStyle } from "app/theme";
                    ...
                    renderItem={({ item, index }) => {
                        ...
                        return (
                            <ListItem
                                ...
                                style={[
                                    themed($listItem),
                                    isSelected && themed($selectedItem),
...
const $checkIcon: ThemedStyle<ViewStyle> = ({ spacing, colors}) => ({
    justifyContent: "center",
    alignSelf: "center",
    height: 20,
    width: 20,
